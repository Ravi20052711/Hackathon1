...
from app.api import auth, ioc, alerts, graph, hunt, feed, reports, systemlogs, ingest
...
app.include_router(ingest.router, prefix="/api/ingest-logs", tags=["Log Ingestion"])
